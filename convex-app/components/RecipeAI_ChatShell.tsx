...
import { RecipeAI_CommunitySelector } from "@/components/RecipeAI_CommunitySelector";
import { RecipeAI_ChatLog } from "@/components/RecipeAI_ChatLog";
import { RecipeAI_ChatInput } from "@/components/RecipeAI_ChatInput";
import { RecipeAI_ProfileModal } from "@/components/RecipeAI_ProfileModal";
import { RecipeAI_RecipeRail } from "@/components/RecipeAI_RecipeRail";
import { RecipeAI_BottomNav } from "@/components/RecipeAI_BottomNav";
...
export function RecipeAI_ChatShell() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-950">
        ...
        <div className="mx-auto flex h-full w-full max-w-6xl flex-col gap-6 px-4 py-6 md:flex-row">
          <aside className="md:w-64">
            ...
            <div className="mt-4 hidden md:block">
              <RecipeAI_RecipeRail recipes={recipesByCommunity} orientation="vertical" />
            </div>
          </aside>
          ...
          <section className="flex flex-1 flex-col gap-4">
            ...
            <div className="flex h-full flex-1 flex-col overflow-hidden rounded-3xl border border-slate-800 bg-recipeai-panel shadow-glow">
              <RecipeAI_ChatLog userId={userId} community={community.id} />
              <RecipeAI_ChatInput
                userId={userId}
                email={email}
      ...
      <RecipeAI_BottomNav activeTab={activeTab} onChangeTab={setActiveTab} />
